...
/**
 * Angular2 template context.
 *
 */
public class Angular2Context extends AbstractTypeScriptContext {

	public Angular2Context(TemplateContextType type, IDocument document, int offset, int length) {
		super(type, document, offset, length);
	}

	public Angular2Context(TemplateContextType type, IDocument document, Position position) {
