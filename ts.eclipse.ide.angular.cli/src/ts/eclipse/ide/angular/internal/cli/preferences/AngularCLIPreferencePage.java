...
public class AngularCLIPreferencePage extends PropertyAndPreferencePage {
	...
	public static final String PREF_ID = "ts.eclipse.ide.angular.cli.preference.AngularCLIPreferencePage"; //$NON-NLS-1$
	public static final String PROP_ID = "ts.eclipse.ide.angular.cli.property.AngularCLIPreferencePage"; //$NON-NLS-1$
