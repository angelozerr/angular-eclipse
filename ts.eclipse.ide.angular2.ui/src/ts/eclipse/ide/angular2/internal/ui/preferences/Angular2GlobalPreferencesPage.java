 ...
 * 
 */
public class Angular2GlobalPreferencesPage extends PreferencePage implements IWorkbenchPreferencePage {

	public Angular2GlobalPreferencesPage() {
	...
	protected Control createContents(Composite parent) {
		...
		String description = Angular2UIMessages.Angular2GlobalPreferencesPage_desc;
