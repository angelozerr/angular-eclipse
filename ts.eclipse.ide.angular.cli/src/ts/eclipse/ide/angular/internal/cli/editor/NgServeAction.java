 ...
 *
 */
public class NgServeAction extends AbstractFileAction {

	public NgServeAction(IEditorPart editor) {
		super(editor);
		super.setText(AngularCLIMessages.AngularCLIEditor_NgServeAction_text);
		super.setImageDescriptor(AngularCLIImageResource.getImageDescriptor(AngularCLIImageResource.IMG_NG_SERVE));
	}
	...
	public void run() {
		...
		if (file != null) {
			try {
				AngularCLILaunchHelper.launch(NgCommand.SERVE, file.getProject());
