 ...
 *
 */
public class AngularCoreMessages extends NLS {

	private static final String BUNDLE_NAME = "ts.eclipse.ide.angular.internal.core.AngularCoreMessages"; //$NON-NLS-1$

	private static ResourceBundle fResourceBundle;

	// HTML Angular Bindings errors
