...
public class NewAngularProjectParamsWizardPage extends AbstractWizardPage {
	...
	protected NewAngularProjectParamsWizardPage() {
		super(PAGE_NAME, AngularCLIMessages.NewAngularProjectParamsWizardPage_title, null);
	}
	...
	public void createBody(Composite parent) {
		...
		// Prefix
		label = new Label(paramsGroup, SWT.NONE);
		label.setText(AngularCLIMessages.NewAngularProjectParamsWizardPage_prefix);
		label.setFont(font);
		...
		// Style
		label = new Label(paramsGroup, SWT.NONE);
		label.setText(AngularCLIMessages.NewAngularProjectParamsWizardPage_style);
		label.setFont(font);
		...
		// Skip
		label = new Label(paramsGroup, SWT.NONE);
		label.setText(AngularCLIMessages.NewAngularProjectParamsWizardPage_skip);
		label.setFont(font);

		// Checkbox for Skip install
		chkSkipInstall = new Button(paramsGroup, SWT.CHECK);
		chkSkipInstall.addListener(SWT.Selection, this);
		chkSkipInstall.setText(AngularCLIMessages.NewAngularProjectParamsWizardPage_install);
		data = new GridData(GridData.HORIZONTAL_ALIGN_FILL | GridData.GRAB_HORIZONTAL);
		...
		chkSkipGit.setText(AngularCLIMessages.NewAngularProjectParamsWizardPage_git);
		data = new GridData(GridData.HORIZONTAL_ALIGN_FILL | GridData.GRAB_HORIZONTAL);
		...
		chkSkipTests.setText(AngularCLIMessages.NewAngularProjectParamsWizardPage_tests);
		data = new GridData(GridData.HORIZONTAL_ALIGN_FILL | GridData.GRAB_HORIZONTAL);
		...
		chkSkipCommit.setText(AngularCLIMessages.NewAngularProjectParamsWizardPage_commit);
		data = new GridData(GridData.HORIZONTAL_ALIGN_FILL | GridData.GRAB_HORIZONTAL);
		...
		// Inline
		label = new Label(paramsGroup, SWT.NONE);
		label.setText(AngularCLIMessages.NewAngularProjectParamsWizardPage_inline);
		label.setFont(font);

		// Checkbox for inline style
		chkInlineStyle = new Button(paramsGroup, SWT.CHECK);
		chkInlineStyle.addListener(SWT.Selection, this);
		chkInlineStyle.setText(AngularCLIMessages.NewAngularProjectParamsWizardPage_inlineStyle);
		data = new GridData(GridData.HORIZONTAL_ALIGN_FILL | GridData.GRAB_HORIZONTAL);
		...
		chkInlineTemplate.setText(AngularCLIMessages.NewAngularProjectParamsWizardPage_inlineTemplate);
		data = new GridData(GridData.HORIZONTAL_ALIGN_FILL | GridData.GRAB_HORIZONTAL);
		...
		// Routing
		label = new Label(paramsGroup, SWT.NONE);
		label.setText(AngularCLIMessages.NewAngularProjectParamsWizardPage_routing);
		label.setFont(font);
