 ...
 *     Angelo Zerr <angelo.zerr@gmail.com> - adapt for Angular cli init project.
 *******************************************************************************/
 ...
 *
 * <pre>
 * IWorkbenchWizard wizard = new NewAngularProjectWizard();
 ...
 */
public class NewAngularProjectWizard extends AbstractNewProjectWizard {

	private static final String WIZARD_NAME = "NewAngularProjectWizard";

	private NewAngularProjectParamsWizardPage paramsPage;

	/**
	 * Creates a wizard for creating a new project resource in the workspace.
	 */
	public NewAngularProjectWizard() {
		super(WIZARD_NAME, AngularCLIMessages.NewAngularProjectWizard_newProjectTitle,
				AngularCLIMessages.NewAngularProjectWizard_newProjectDescription);
	}
	...
	public void init(IWorkbench workbench, IStructuredSelection currentSelection) {
		...
		setWindowTitle(AngularCLIMessages.NewAngularProjectWizard_windowTitle);
	}

	@Override
	protected void initializeDefaultPageImageDescriptor() {
		ImageDescriptor desc = AngularCLIImageResource.getImageDescriptor(AngularCLIImageResource.IMG_ANGULAR_WIZBAN);
	...
	public void addPages() {
		...
		paramsPage = new NewAngularProjectParamsWizardPage();
