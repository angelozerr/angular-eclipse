...
import ts.eclipse.ide.angular2.internal.ui.style.SemanticHighlightingManager;
import ts.eclipse.ide.angular2.ui.Angular2UIPlugin;
import ts.eclipse.ide.angular2.ui.style.AbstractAngularSemanticHighlighting;
 ...
 */
public final class HTMLAngular2EditorSyntaxColoringPreferencePage extends AbstractSyntaxColoringPage
		implements IWorkbenchPreferencePage {

	private static final String EXAMPLE_TEXT_FILE_NAME = HTMLAngular2EditorSyntaxColoringPreferencePage.class.getName()
			+ ".xml";
	...
	private String getExampleText() {
		return Angular2UIMessages.Sample_HTMLAngular2_doc;
	}
	...
	private Collection getStylePreferenceKeys() {
		if (fStylePreferenceKeys == null) {
			...
			styles.add(IStyleConstantsForAngular.ANGULAR2_EXPRESSION_BORDER);
			styles.add(IStyleConstantsForAngular.ANGULAR2_EXPRESSION);
			styles.add(IStyleConstantsForAngular.ANGULAR2_DIRECTIVE_NAME);
